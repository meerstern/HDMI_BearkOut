...
/* Module Version: 5.7 */
/* C:\lscc\diamond\3.10_x64\ispfpga\bin\nt64\scuba.exe -w -n clk -lang verilog -synth lse -arch xo3c00f -type pll -fin 13.3 -fclkop 40 -fclkop_tol 10.0 -trimp 0 -phasep 0 -trimp_r -phase_cntl STATIC -fb_mode 1  */
/* Thu Jan 17 22:44:37 2019 */


`timescale 1 ns / 1 ps
module clk (CLKI, CLKOP)/* synthesis NGD_DRC_MASK=1 */;
    input wire CLKI;
    output wire CLKOP;
    ...
    EHXPLLJ PLLInst_0 (.CLKI(CLKI), .CLKFB(CLKOP_t), .PHASESEL1(scuba_vlo), 
        ...
        .PLLDATO2(), .PLLDATO1(), .PLLDATO0())
             /* synthesis FREQUENCY_PIN_CLKOP="39.900000" */
             /* synthesis FREQUENCY_PIN_CLKI="13.300000" */
    ...
    // exemplar begin
    // exemplar attribute PLLInst_0 FREQUENCY_PIN_CLKOP 39.900000
    // exemplar attribute PLLInst_0 FREQUENCY_PIN_CLKI 13.300000
